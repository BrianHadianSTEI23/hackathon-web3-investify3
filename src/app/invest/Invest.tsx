        ...
        <div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-4">
            {trendingToday.map((stock, index) => (
              <div key={index} className="bg-white p-5 rounded-xl shadow-md text-center border border-gray-200">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
            {paginatedStocks.map((item, index) => (
              <div key={index} className="flex justify-between items-center p-5 bg-white rounded-xl shadow-md border border-gray-200">
